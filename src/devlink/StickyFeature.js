      ...
      <_Builtin.Block className="padding-global" tag="div">
        <_Builtin.Block className="container-medium" tag="div">
          <_Builtin.Block className="padding-section-medium" tag="div">
            <_Builtin.Block className="sticky-feature_component" tag="div">
              <_Builtin.Block
                className="sticky-feature_image-wrapper"
                tag="div"
              >
                <_Builtin.Image
                  className="sticky-feature_image"
                  loading="eager"
                  width="auto"
                  height="auto"
              ...
              <_Builtin.Block className="sticky-feature_text-wrapper" tag="div">
                ...
                <_Builtin.Block className="spacer-xsmall" tag="div" />
                <_Builtin.Heading className="award-subheading" tag="h2">
                  {
                    "Zahnärztliche Gemeinschaftspraxis Ladar Dr. Desirée Ladar, Dr. Emil Ladar, Freudenstadt"
                  }
                </_Builtin.Heading>
                <_Builtin.Block className="spacer-xsmall" tag="div" />
                <_Builtin.Paragraph className="paragraph p-mb">
                  {
