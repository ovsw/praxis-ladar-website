...
export function Menu({
  ...
  return (
    ...
    >
      <_Builtin.Block className="navbar for-menu" tag="div">
      ...
      <_Builtin.Block className="menu-links-container" tag="div">
        <_Builtin.Link className="menu-link" button={false} options={homeLink}>
          ...
          <_Builtin.Block className="menu-link-text-wrapper" tag="div">
            <_Builtin.Block className="big-text for-menu customized" tag="div">
              {"Home"}
            </_Builtin.Block>
          </_Builtin.Block>
          <_Builtin.Block className="menu-background-image" tag="div">
            <_Builtin.Image
              className="image for-menu"
              loading="lazy"
              width="auto"
              height="auto"
              alt=""
      ...
      <_Builtin.Block className="menu-socials" tag="div">
        <_Builtin.Link
        ...
        >
          <_Builtin.Block className="menu-social-text" tag="div">
            {"facebook"}
          </_Builtin.Block>
          <_Builtin.Block className="menu-social-text absolute" tag="div">
            {"facebook"}
          </_Builtin.Block>
        </_Builtin.Link>
        <_Builtin.Link
      ...
      <_Builtin.Block className="menu-underlay" tag="div" />
    </_Component>
  );
}
