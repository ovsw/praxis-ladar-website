...
import _styles from "./Statistics.module.css";
...
export function Statistics({ as: _Component = _Builtin.Section }) {
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "section", "experience-section")}
      grid={{
        type: "section",
      }}
      tag="div"
    >
      ...
      >
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "experience-container")}
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "experience")}
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "perspective-wrapper")}
              tag="div"
            >
              <_Builtin.Block
                className={_utils.cx(
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "experience", "padding-1")}
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "perspective-wrapper")}
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "experience", "padding-2")}
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "perspective-wrapper")}
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "experience", "padding-3")}
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "perspective-wrapper")}
          ...
          >
            ...
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "infinite-image-wrapper")}
                tag="div"
              >
                <_Builtin.Image
                  className={_utils.cx(_styles, "full-width-image")}
                  loading="lazy"
                  width="auto"
                  height="auto"
                  alt=""
