  ...
  return (
    ...
    >
      <_Builtin.Block className="footer-container" tag="div">
        <_Builtin.Block className="upper-footer" tag="div">
          <_Builtin.Block className="lets-talk-container" tag="div">
            <_Builtin.Image
            ...
            <_Builtin.Block
              ...
              tag="div"
            >
              <_Builtin.Block className="flex-mobile hidden" tag="div">
                <_Builtin.Block className="big-text for-footer" tag="div">
                  {"Lass uns"}
                </_Builtin.Block>
                <_Builtin.Block
                  className="big-text for-footer relative"
                  tag="div"
                >
                  {"reden"}
                </_Builtin.Block>
              ...
              <_Builtin.Block
                className="footer-secondary-button-wrapper"
                tag="div"
              >
                <_Builtin.Link
                ...
                >
                  <_Builtin.Block
                    className="secondary-btn-text-wrapper"
                    tag="div"
                  >
                    <_Builtin.Block
                      className="secondary-button-text for-footer"
                      tag="div"
                    ...
                    <_Builtin.Block
                      className="secondary-button-text for-footer absolute"
                      tag="div"
                      sym-bind='{"children":{"type":"Select","val":{"from":{"type":"Variable","val":"data"},"prop":"744dc146-b5c7-8279-1a9e-aecb2fdb76c6"}}}'
                    >
                      {"Kontakt"}
                  ...
                  <_Builtin.Block
                    className="secondary-btn-arrow-wrapper for-footer"
                    tag="div"
                  >
                    <_Builtin.Image
                    ...
                    />
                    <_Builtin.Image
                      className="arrow-right translate-left"
                      loading="lazy"
                      width="auto"
                      height="auto"
                      alt=""
          ...
          <_Builtin.Block className="main-links" tag="div">
            <_Builtin.Block className="footer-links-container" tag="div">
              <_Builtin.Block
                className="footer-links-column sideline-on-mobile"
                tag="div"
              >
                <_Builtin.Block className="footer-link title" tag="div">
                  {"Praxis Ladar"}
                </_Builtin.Block>
                <_Builtin.Block className="footer-link-column-grid" tag="div">
                  <_Builtin.Link
                  ...
                  >
                    ...
                    <_Builtin.Block className="footer-link absolute" tag="div">
                      {"Home"}
                    </_Builtin.Block>
                  </_Builtin.Link>
                  <_Builtin.Link
            ...
            <_Builtin.Block
              className="socials-and-newsletter-container"
              tag="div"
            >
              <_Builtin.Block className="socials" tag="div">
                <_Builtin.Link
                  className="social"
                  button={false}
                  block="inline"
        ...
        <_Builtin.Block className="lower-footer" tag="div">
          <_Builtin.Block className="footer-line" tag="div" />
          <_Builtin.Block className="lower-footer-item" tag="div">
            <_Builtin.Block className="footer-link secondary smaller" tag="div">
              {"©2023 "}
              <_Builtin.Link
