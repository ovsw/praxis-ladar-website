...
import _styles from "./CustomFeatureRight.module.css";
...
export function CustomFeatureRight({ as: _Component = _Builtin.Section }) {
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "hero", "for-about", "toppad")}
      grid={{
        type: "section",
      }}
      tag="div"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <_Builtin.Image
                className={_utils.cx(_styles, "image", "is-full-width-mobile")}
                loading="eager"
                width="auto"
                height="auto"
