...
export function SectionUberUns({ as: _Component = _Builtin.Section }) {
  ...
  return (
    <_Component
      className="section_about-animated"
      grid={{
        type: "section",
      }}
      tag="section"
    >
      <_Builtin.Block className="about-animated_component" tag="div">
        <_Builtin.Block
          className="about-animated_track"
          data-w-id="f250a8c2-4623-3422-2031-e6565be05957"
          tag="div"
        >
          <_Builtin.Block className="about-animated_container" tag="div">
            <_Builtin.Block
              className="about-animated_container-inner"
              tag="div"
            >
              <_Builtin.Block
              ...
              >
                ...
                <_Builtin.Block
                  className="about-animated_line-animations-container-mobile"
                  tag="div"
                >
                  <_Builtin.Block
                    className="benefit-mobile"
                    data-w-id="f250a8c2-4623-3422-2031-e6565be05963"
                    tag="div"
                  >
                    <_Builtin.Block
                      className="button_wrapper horizontal align-center"
                      tag="div"
                    >
                      <_Builtin.Block className="benefit-line-mobile" tag="div">
                        <_Builtin.Block
                          className="benefit-horizontal-line"
                          tag="div"
                        />
                        <_Builtin.Block className="benefit-circle" tag="div" />
                      </_Builtin.Block>
                      <_Builtin.Block className="experience-wrapper" tag="div">
                        <_Builtin.Block className="experience-number" tag="div">
                          {"1"}
                        </_Builtin.Block>
                        <_Builtin.Block
                          className="about-animated_item-text"
                          tag="div"
                        >
                          {"Designpreis"}
                        </_Builtin.Block>
                  ...
                  >
                    ...
                    >
                      <_Builtin.Block
                        className="benefit-line-mobile line-2"
                        tag="div"
                      >
                        <_Builtin.Block
                          className="benefit-horizontal-line"
                  ...
                  >
                    ...
                    >
                      <_Builtin.Block
                        className="benefit-line-mobile line-3"
                        tag="div"
                      >
                        <_Builtin.Block
                          className="benefit-horizontal-line"
                ...
                <_Builtin.Block className="padding-global" tag="div">
                  <_Builtin.Paragraph className="max-width-small">
                    {
              ...
              <_Builtin.Block
                className="about-animated_items-container"
                tag="div"
              >
                <_Builtin.Block
                  className="about-animated_item"
                  id="w-node-f250a8c2-4623-3422-2031-e6565be0598e-5be05956"
                  tag="div"
                >
                  <_Builtin.Block
                    className="about-animated_item-inner"
                    tag="div"
                  >
                    <_Builtin.Block className="button_wrapper center" tag="div">
                      <_Builtin.Block className="vertical-line" tag="div" />
                      <_Builtin.Block className="line-circle" tag="div" />
                    </_Builtin.Block>
                    <_Builtin.Block
                      className="experience-number-container"
                      tag="div"
                    >
                      <_Builtin.Block className="experience-number" tag="div">
                        {"10"}
                      ...
                      <_Builtin.Block
                        className="experience-number absolute first"
                      ...
                      <_Builtin.Block
                        className="experience-number absolute"
                ...
                <_Builtin.Block
                  className="about-animated_item second"
                  id="w-node-f250a8c2-4623-3422-2031-e6565be059a0-5be05956"
                  tag="div"
                >
                  <_Builtin.Block
                    className="about-animated_item-inner"
                ...
                <_Builtin.Block
                  className="about-animated_item third"
                  id="w-node-f250a8c2-4623-3422-2031-e6565be059b4-5be05956"
                  tag="div"
                >
                  <_Builtin.Block
                    className="about-animated_item-inner"
