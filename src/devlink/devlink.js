        ...
        [wL]: {
          ...
          handler: (
            ...
            return (
              ...
              { elementHovered: v, clientX: p, clientY: f, pageX: E, pageY: y }
            );
          },
        },
        [BL]: {
...
function xD({
  ...
  let { ixData: l, ixSession: d } = e.getState(),
    ...
    { id: m } = a;
  uD(E, o) && (m = cD(t, m));
  let v = d.hasBoundaryNodes && r ? gt(r, hr) : null;
  _.forEach((h) => {
  ...
  if (u && u.useFirstGroupAsInitialState) {
    ...
    l.forEach((p) => {
      ...
      g.forEach((_) => {
        ...
        wo({
          destination: Mo({ element: _, actionItem: p, elementApi: U }, m),
          immediate: !0,
          store: e,
          element: _,
          eventId: r,
...
function qo(e, t) {
  ...
  let { elementId: r, actionItem: n } = e,
    ...
    { ref: i, refType: a } = o[r] || {};
  a === EE && lD(i, n, U), t.dispatch(go(e.id));
}
function mE(e, t, r) {
  ...
  if (vr(S, h.mediaQueryKey) && (n || r || o)) {
    if (l || (u === eD && o)) {
      ...
      let { ixElements: A } = t.getState(),
        ...
        P = x && x[s];
      (b === EE || Sr(s)) && nD(R, x, P, p, a, I, U, u, m);
    }
    if (o) {
      if (g) {
        let A = Tt({
