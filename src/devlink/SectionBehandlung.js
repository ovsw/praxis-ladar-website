...
import _styles from "./SectionBehandlung.module.css";
...
export function SectionBehandlung({ as: _Component = _Builtin.Section }) {
  _interactions.useInteractions(_interactionsData, _styles);

  return (
    <_Component
      className={_utils.cx(_styles, "section_sticky-lines-large")}
      grid={{
        type: "section",
      }}
      tag="section"
    ...
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "wide-container")}
        tag="div"
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "home-services-container")}
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                ...
                <br />
                {
                  "In unserer Zahnarztpraxis setzen wir auf hochmoderne Technologie, um Ihr Wohlbefinden und Ihre Zahngesundheit zu fördern. "
                }
              </_Builtin.Paragraph>
              <_Builtin.Block
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "home-services-animation-container")}
            data-w-id="013f7e94-4b70-18d2-b906-f2ba4590e23d"
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "animation-line-column")}
              tag="div"
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "animation-item")}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "outer-line-wrapper")}
                  tag="div"
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "line-wrapper", "alt")}
                ...
                <_Builtin.Link
                  className={_utils.cx(_styles, "animation-item-text", "link")}
                ...
                >
                  ...
                  <_Builtin.Block
                    className={_utils.cx(_styles, "more-info-wrapper")}
                    tag="div"
                  >
                    <_Builtin.Block
                      className={_utils.cx(_styles, "more-info")}
                      tag="div"
                    >
                      {"mehrinfos"}
                    </_Builtin.Block>
              ...
              >
                ...
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "line-wrapper", "short")}
            ...
            >
              ...
              >
                ...
                <_Builtin.Link
                  className={_utils.cx(_styles, "servicelink")}
                ...
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "animation-item-text")}
                    tag="div"
                  >
                    {"Bleaching"}
                  </_Builtin.Block>
