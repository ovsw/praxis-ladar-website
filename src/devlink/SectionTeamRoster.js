...
import _styles from "./SectionTeamRoster.module.css";
...
export function SectionTeamRoster({
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "team6_list-wrapper")}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "team6_list")}
                  tag="div"
                >
                  {teamListSlot ?? (
                    <>
