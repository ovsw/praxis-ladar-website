...
import _styles from "./SectionPraxisteam.module.css";
...
export function SectionPraxisteam({
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "section_sticky-slider")}
      grid={{
        type: "section",
      }}
      tag="section"
    ...
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "sticky-slider_container")}
      ...
      >
        ...
        >
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "section-outlined-heading-trigger")}
            data-w-id="306bdaf8-8a78-9bdc-95ec-0cda47ef1473"
            tag="div"
          />
        </_Builtin.Block>
        <_Builtin.Block
          className={_utils.cx(_styles, "sticky-slider_component")}
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "sticky-slider_item")}
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "sticky-slider_text")}
            ...
            >
              ...
              <_Builtin.Block
                className={_utils.cx(_styles, "sticky-slider_line")}
                tag="div"
              />
              <_Builtin.Block
                className={_utils.cx(
                  _styles,
                  "sticky-slider_paragraphs-wrapper"
                )}
                tag="div"
              >
                <_Builtin.Paragraph
                  className={_utils.cx(_styles, "paragraph", "bio-motto")}
                  dyn={{
                    bind: {},
                  }}
                ...
                <_Builtin.RichText
                  className={_utils.cx(_styles, "sticky-slider_rich-text")}
                  tag="div"
                >
            ...
            <_Builtin.Block
              className={_utils.cx(_styles, "sticky-slider_image-wrapper")}
              tag="div"
            >
              <_Builtin.Block
                className={_utils.cx(
                  _styles,
                  "sticky-slider_image-wrapper-inner"
                )}
              ...
              <_Builtin.Block
                className={_utils.cx(
                  _styles,
                  "sticky-slider_big-heading-wrapper"
                )}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "section-title-wrapper")}
                  tag="div"
                >
                  <_Builtin.Block
                    className={_utils.cx(
          ...
          >
            ...
            >
              ...
              >
                <_Builtin.Image
                  className={_utils.cx(_styles, "sticky-slider_image")}
                  dyn={{
                    bind: {},
                  }}
                  height="auto"
              ...
              >
                ...
                >
                  <_Builtin.List tag="ul" unstyled={false}>
                    ...
                    <_Builtin.ListItem>
                      {
                        "(Seit 2020) Angestellte Zahnärztin bei der Gemeinschaftspraxis Dres. Ladar in Freudenstadt"
                      }
                    </_Builtin.ListItem>
                    <_Builtin.ListItem>
                      {
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "sticky-slider_item", "last")}
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "sticky-slider_progres-bar")}
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "sticky-slider_inner-bar")}
